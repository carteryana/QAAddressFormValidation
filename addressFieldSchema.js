var addressSchema = {
  ...
  "options": [
          ...
          "locality": [
            ...
            {"localityname": {"label": "City"}},
            {
              "administrativearea": {
                ...
                "options": [
                  {"": "--"},
                  {"AI": "Ays�n del General Carlos Ib��ez del Campo"},
                  {"AN": "Antofagasta"},
                  {"AR": "Araucan�a"},
                  ...
                  {"LL": "Los Lagos"},
                  {"LR": "Los R�os"},
                  {"MA": "Magallanes y de la Ant�rtica Chilena"},
                  {"ML": "Maule"},
            ...
            {"localityname": {"label": "City"}},
            {
              "administrativearea": {
                ...
                "options": [
                  ...
                  {"AL": "Alessandria"},
                  {"AN": "Ancona"},
                  {"AO": "Valle d'Aosta/Vall�e d'Aoste"},
                  {"AP": "Ascoli Piceno"},
                  {"AQ": "L'Aquila"},
                  {"AR": "Arezzo"},
                  {"AT": "Asti"},
    ...
    },
    {
      ...
      "iso": "US",
      "fields": [
        {"thoroughfare": {"label": "Address 1", "eg": "123 main street"}},
        {"premise": {"label": "Address 2"}},
        {
          "locality": [
            {"localityname": {"label": "City"}},
